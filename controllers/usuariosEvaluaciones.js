import UsuariosEvaluaciones from "../models/usuariosEvaluaciones.js";


const findAll = async (req, res) => {
  try {
    const cuestionarios = await UsuariosEvaluaciones.findAll();
...
const findById = async (req, res) => {
  try {
    const cuestionario = await UsuariosEvaluaciones.findByPk(req.params.id);
    if (cuestionario) {
